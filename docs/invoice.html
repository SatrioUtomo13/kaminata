...
<body>
    ...
    <div class="container flex  w-full h-screen max-w-full" id="main">
        ...
        <div class="bg-secondary basis-1/4">
            ...
            <div class="flex justify-around h-32 items-center ">
                ...
                <!-- <img src="../asset/img/navbar1.png" alt="menu" class="w-[10%] cursor-pointer"> -->
            </div>
            <!-- finish logo -->
            <!-- start menu -->
        ...
        <div class="bg-primary grow relative">
            ...
            <header class="flex items-center mx-12 mt-3 justify-between ">
                ...
                <div class="flex">
                    ...
                    <h1 class="text-5xl font-poppins self-center font-bold">Invoice</h1>
                </div>
                <!-- finish logo -->
                <div class="flex">
                    <img src="../asset/img/profil.png" alt="profile" class="w-16 h-1/6 cursor-pointer" id="profile">
                    <!-- start profile click -->
                    <div class="bg-[#D9D9D9] py-5 pr-7 absolute right-12 top-[70px] font-poppins rounded-xl hidden " id="profile-click">
                        <div class="mx-3">
            ...
            <!-- finish header -->
            <!-- start tambah & hapus -->
            <div class="flex items-center mx-12 mt-3 justify-between">
                <div class="flex bg-white h-9 w-52 rounded-md border border-black shadow-[0_4px_4px_rgba(0,0,0,0.25)]">
                    <input type="text" name="" id="" placeholder="Search No Invoice" class="ml-3 w-4/5 outline-none text-black placeholder:text-black placeholder:font-bold">
                    <svg viewBox="0 0 24 24" class="self-center w-7">
                        <path fill="currentColor" d="M9.5,3A6.5,6.5 0 0,1 16,9.5C16,11.11 15.41,12.59 14.44,13.73L14.71,14H15.5L20.5,19L19,20.5L14,15.5V14.71L13.73,14.44C12.59,15.41 11.11,16 9.5,16A6.5,6.5 0 0,1 3,9.5A6.5,6.5 0 0,1 9.5,3M9.5,5C7,5 5,7 5,9.5C5,12 7,14 9.5,14C12,14 14,12 14,9.5C14,7 12,5 9.5,5Z" />
                    </svg>
                </div>
                <div class="flex bg-white h-9 w-1/6 rounded-md border border-black shadow-[0_4px_4px_rgba(0,0,0,0.25)] justify-around">
                    <h1 class="self-center font-bold">Date</h1>
                    <svg style="width:24px;height:24px" viewBox="0 0 24 24" class="cursor-pointer rotate-90 self-center">
                        <path fill="currentColor" d="M8.59,16.58L13.17,12L8.59,7.41L10,6L16,12L10,18L8.59,16.58Z" />
                    </svg>
                </div>
                <p>showing 1 to 6 of 20 entire</p>
                <div class="bg-secondary h-9 w-1/5 rounded-md text-white shadow-[0_4px_4px_rgba(0,0,0,0.25)] text-center leading-loose font-bold cursor-pointer">
                    Export to PDF File
                </div>
            </div>            
            <!-- finish tambah & hapus -->            
            <!-- start table -->
            <table class= "mx-12 w-11/12 gfg">
                <tr class="text-left">
                ...
                <tr class="text-left outline outline-black rounded-md">
                    <td class="gff">
                        <input type="checkbox" name="" id="">
                    </td>
                    <td>#INV-01-090722</td>
                    <td class="text-left">
                        <p class="font-semibold">Kadita Saputra</p>
                        <p class="font-thin">Kasemen,Serang</p>
                    </td>
                    <td class="flex leading-10 text-green-500">Selesai
                        <svg style="width:24px;height:24px" viewBox="0 0 24 24" class="self-center">
                    ...
                    <td class="text-left">
                        ...
                        <p class="font-thin">07 Juli 2022, 00:45</p>
                    </td>
                    <td>Rp.2.000.000</td>
                    <td class="flex leading-10 text-blue-500">View Detail
                        <svg style="width:24px;height:24px" viewBox="0 0 24 24" class="self-center">
                            <path fill="currentColor" d="M19,19H5V5H15V3H5C3.89,3 3,3.89 3,5V19A2,2 0 0,0 5,21H19A2,2 0 0,0 21,19V11H19M7.91,10.08L6.5,11.5L11,16L21,6L19.59,4.58L11,13.17L7.91,10.08Z" />
                        </svg>
                    </td>
            ...
            <!-- finish table -->
            <!-- start nav -->
            <nav class="flex w-1/4 m-auto justify-between">
                <svg style="width:24px;height:24px" viewBox="0 0 24 24" class="cursor-pointer">
                    <path fill="currentColor" d="M15.41,16.58L10.83,12L15.41,7.41L14,6L8,12L14,18L15.41,16.58Z" />
                </svg>
                <a href="" class="w-8 visited:bg-red-300  text-center rounded-lg">1</a>
                <a href="">2</a>
                <a href="">3</a>
                <svg style="width:24px;height:24px" viewBox="0 0 24 24" class="cursor-pointer">
                    <path fill="currentColor" d="M8.59,16.58L13.17,12L8.59,7.41L10,6L16,12L10,18L8.59,16.58Z" />
    ...
    <!-- start copyright -->
    <div class="absolute bottom-5 right-12 flex">
        ...
        <p class="font-mono text-sm self-center font-bold">Copyright by Dr.Chip</p>
    </div>
    <!-- finish copyright -->
